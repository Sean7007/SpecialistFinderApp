package com.example.specialistfinderapp.CustomerFragments.ChatActivity;
                            ...
                            public void onClick(DialogInterface dialogInterface, int position) {
                                if (position == 0) {
                                   deleteSentMessage(position,messageViewHolder);
                                    Intent intent = new Intent(messageViewHolder.itemView.getContext(),ChatMainActivity.class);
                                    messageViewHolder.itemView.getContext().startActivity(intent);
